...
export default function FriendDetail() {
  ...
  const friend = useMemo(() => {
    return friendsData.find((f) => f.id === Number(id)) || null;
  }, [id]);
  ...
  const handleCheckIn = (type) => {
    ...
    const existingTimeline = JSON.parse(
      localStorage.getItem("friend_timeline") || "[]"
    );
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          >
            <div className="card-body p-8 items-center text-center">
              <div className="w-32 h-32 relative rounded-full overflow-hidden mb-6 border-4 border-gray-50">
                <Image
                  src={friend.picture}
                  alt={friend.name}
                  fill
              ...
              <div
                className={cn(
                  "px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-4",
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-6">
                {friend.tags.map((tag) => (
                  <div
                    key={tag}
                    className="px-2 py-0.5 bg-[#E8F5E9] text-primary text-[10px] font-bold rounded uppercase tracking-wider"
                  >
                    {tag}
                  </div>
                ))}
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              >
                <div className="text-2xl font-black mb-2 text-[#244D3F]">
                  {states.value}
                </div>
                <div className="text-base opacity-50 font-medium">
                  {states.label}
                </div>
              </motion.div>
            ))}
          ...
          >
            <div className="card-body p-10">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-black text-[#244D3F]">
                  Relationship Goal
                </h2>
          ...
          >
            <div className="card-body p-10">
              <h2 className="text-2xl font-black text-[#244D3F] mb-8">
                Quick Check-In
              </h2>
